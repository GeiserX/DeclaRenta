...
| Proyecto | Autor | Lenguaje | Utilidad para DeclaRenta |
|----------|-------|----------|------------------------|
| **burocratin** | vaijira | Rust/WASM | Referencia formato AEAT 720 y D-6 |
| **IBKR-RENTA** | AlbertoPorras | HTML/JS | Referencia mapeo casillas Modelo 100 |
| **ibflex** | csingley | Python | Referencia campos Flex Query XML |
