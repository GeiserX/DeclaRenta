...
const en: TranslationKeys = {
  ...
  "guide_rw.clave_prereq_hint": "In Renta Web, boxes <strong>1633</strong> (transmission value) and <strong>1637</strong> (acquisition value) <strong>stay disabled until you first fill these fields, in this order</strong>:<br>1) Box <strong>1626 \"Type of asset — Code\"</strong> → for foreign currency, options, crypto or funds this is usually code <strong>4</strong> (\"Other assets not linked to economic activities\").<br>2) <strong>\"Type of transfer\"</strong> → <strong>\"Transmisión intervivos onerosa\"</strong> (sale, swap, etc.) — it is <strong>onerosa</strong> (for consideration), not lucrativa/gratuita.<br>3) <strong>Transmission date</strong> (boxes <strong>1631/1632</strong>) → day/month/year of the sale.<br>4) <strong>Acquisition date</strong> (box <strong>1932</strong>) → day/month/year of the purchase.<br>Once filled, boxes 1633 and 1637 unlock and you can type the amounts.",
