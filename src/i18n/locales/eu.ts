...
const eu: TranslationKeys = {
  ...
  "guide.ibkr.step5": "Atal bakoitzean, <strong>hautatu eremu guztiak</strong> (markatu lauki guztiak). Zenbat eta datu gehiago sartu, orduan eta kalkulua zehatzagoa. Gutxienez, ziurtatu <strong>Notes</strong> eremua Eragiketa atalean sartzen duzula — dibisa bihurtzeen detekziorako beharrezkoa da.",
