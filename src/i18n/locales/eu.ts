...
const eu: TranslationKeys = {
  ...
  "guide.ibkr.step3": "Sortu <em>Activity Flex Query</em> berria hauek barne:<ul><li>Trades (nahitaezkoa)</li><li>Cash Transactions — dibidenduak eta atxikipenak (nahitaezkoa)</li><li>Open Positions — 720 Eredu/D-6-rako (gomendatua)</li><li>Securities Info — ISINak (gomendatua)</li></ul>",
  "guide.ibkr.step4": "Irteera-formatua: <strong>XML</strong>",
  "guide.ibkr.step5": "Sartu <strong>eskuragarri dauden urte guztiak</strong> FIFO kalkulu zuzenerako",
  "guide.ibkr.step6": "Exekutatu kontsulta eta deskargatu <code>.xml</code> fitxategia",
