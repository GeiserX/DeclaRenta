...
const eu: TranslationKeys = {
  ...
  "guide_rw.valor_transmision_hint": "DeclaRenta-ren <strong>0327</strong> gelaxkako zenbatekoa (EUR, komisioak sartuta).",
  "guide_rw.valor_adquisicion_hint": "DeclaRenta-ren <strong>0328</strong> gelaxkako zenbatekoa (EUR, komisioak sartuta).",
