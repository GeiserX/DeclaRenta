...
const es = {
  ...
  "guide_rw.valor_transmision_hint": "El importe de la casilla <strong>0327</strong> de DeclaRenta (EUR, comisiones ya incluidas).",
  "guide_rw.valor_adquisicion_hint": "El importe de la casilla <strong>0328</strong> de DeclaRenta (EUR, comisiones ya incluidas).",
