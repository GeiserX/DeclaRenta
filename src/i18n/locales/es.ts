...
const es = {
  ...
  "guide.ibkr.step5": "En cada sección, <strong>selecciona todos los campos disponibles</strong> (marca todas las casillas). Cuantos más datos incluyas, más preciso será el cálculo. Como mínimo asegúrate de incluir el campo <strong>Notes</strong> en Operaciones — es necesario para detectar conversiones automáticas de divisa.",
