...
const ca: TranslationKeys = {
  ...
  "guide.ibkr.step3": "Crea una nova <em>Activity Flex Query</em> incloent:<ul><li>Trades (obligatori)</li><li>Cash Transactions — dividends i retencions (obligatori)</li><li>Open Positions — per al Model 720/D-6 (recomanat)</li><li>Securities Info — ISINs (recomanat)</li></ul>",
  "guide.ibkr.step4": "Format de sortida: <strong>XML</strong>",
  "guide.ibkr.step5": "Inclou <strong>tots els anys disponibles</strong> per al càlcul FIFO correcte",
  "guide.ibkr.step6": "Executa la query i descarrega el fitxer <code>.xml</code>",
