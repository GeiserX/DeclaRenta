...
const ca: TranslationKeys = {
  ...
  "guide_rw.clave_prereq_hint": "A Renta Web, les caselles <strong>1633</strong> (valor de transmissió) i <strong>1637</strong> (valor d'adquisició) <strong>apareixen deshabilitades fins que omplis abans aquests camps, en aquest ordre</strong>:<br>1) Casella <strong>1626 «Tipus d'element patrimonial. Clau»</strong> → per a divises, opcions, cripto o fons sol ser la clau <strong>4</strong> («Altres elements patrimonials no afectes a activitats econòmiques»).<br>2) <strong>«Tipus de transmissió»</strong> → <strong>«Transmissió intervivos onerosa (venda, permuta, etc.)»</strong> — és <strong>onerosa</strong>, no lucrativa/gratuïta.<br>3) <strong>Data de transmissió</strong> (caselles <strong>1631/1632</strong>) → dia/mes/any de la venda.<br>4) <strong>Data d'adquisició</strong> (casella <strong>1932</strong>) → dia/mes/any de la compra.<br>Un cop emplenats, les caselles 1633 i 1637 s'activen i hi podràs escriure els imports.",
