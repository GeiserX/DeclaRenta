...
const ca: TranslationKeys = {
  ...
  "guide_rw.valor_transmision_hint": "L'import de la casella <strong>0327</strong> de DeclaRenta (EUR, comissions ja incloses).",
  "guide_rw.valor_adquisicion_hint": "L'import de la casella <strong>0328</strong> de DeclaRenta (EUR, comissions ja incloses).",
