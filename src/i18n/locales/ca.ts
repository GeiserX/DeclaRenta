...
const ca: TranslationKeys = {
  ...
  "guide.ibkr.step5": "A cada secció, <strong>selecciona tots els camps disponibles</strong> (marca totes les caselles). Com més dades incloguis, més precís serà el càlcul. Com a mínim, assegura't d'incloure el camp <strong>Notes</strong> a Operacions — és necessari per detectar conversions automàtiques de divisa.",
